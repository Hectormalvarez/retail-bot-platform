...
class TelegramUser(models.Model):
    ...
    is_active = models.BooleanField(default=True, help_text="False if the user stopped/blocked the bot")
...
class Order(models.Model):
    ...
    shipping_address = models.JSONField(blank=True, null=True, help_text="Raw shipping data returned from successful_payment")
    created_at = models.DateTimeField(auto_now_add=True)
